...
void vTaskGeneralTelemetry(void)
{
    ...
    while(1)
    {
        ...
        if (sat_data_buf.obdh.data.general_telemetry_on) // cppcheck-suppress misra-c2012-14.4
        {
			...
			gen_tel_pl.payload[69] = (sat_data_buf.data.media.last_page_obdh_data >> 24U) & 0xFFU;
			gen_tel_pl.payload[70] = (sat_data_buf.data.media.last_page_obdh_data >> 16U) & 0xFFU;
			gen_tel_pl.payload[71] = (sat_data_buf.data.media.last_page_obdh_data >> 8U) & 0xFFU;
			gen_tel_pl.payload[72] = sat_data_buf.data.media.last_page_obdh_data & 0xFFU;
			gen_tel_pl.payload[73] = (sat_data_buf.data.media.last_page_eps_data >> 24U) & 0xFFU;
			gen_tel_pl.payload[74] = (sat_data_buf.data.media.last_page_eps_data >> 16U) & 0xFFU;
			gen_tel_pl.payload[75] = (sat_data_buf.data.media.last_page_eps_data >> 8U) & 0xFFU;
			gen_tel_pl.payload[76] = sat_data_buf.data.media.last_page_eps_data & 0xFFU;
			gen_tel_pl.payload[77] = (sat_data_buf.data.media.last_page_ttc_0_data >> 24U) & 0xFFU;
			gen_tel_pl.payload[78] = (sat_data_buf.data.media.last_page_ttc_0_data >> 16U) & 0xFFU;
			gen_tel_pl.payload[79] = (sat_data_buf.data.media.last_page_ttc_0_data >> 8U) & 0xFFU;
			gen_tel_pl.payload[80] = sat_data_buf.data.media.last_page_ttc_0_data & 0xFFU;
			gen_tel_pl.payload[81] = (sat_data_buf.data.media.last_page_ttc_1_data >> 24U) & 0xFFU;
			gen_tel_pl.payload[82] = (sat_data_buf.data.media.last_page_ttc_1_data >> 16U) & 0xFFU;
			gen_tel_pl.payload[83] = (sat_data_buf.data.media.last_page_ttc_1_data >> 8U) & 0xFFU;
			gen_tel_pl.payload[84] = sat_data_buf.data.media.last_page_ttc_1_data & 0xFFU;
			gen_tel_pl.payload[85] = (sat_data_buf.data.media.last_page_ant_data >> 24U) & 0xFFU;
			gen_tel_pl.payload[86] = (sat_data_buf.data.media.last_page_ant_data >> 16U) & 0xFFU;
			gen_tel_pl.payload[87] = (sat_data_buf.data.media.last_page_ant_data >> 8U) & 0xFFU;
			gen_tel_pl.payload[88] = sat_data_buf.data.media.last_page_ant_data & 0xFFU;
			gen_tel_pl.payload[89] = (sat_data_buf.data.media.last_page_edc_data >> 24U) & 0xFFU;
			gen_tel_pl.payload[90] = (sat_data_buf.data.media.last_page_edc_data >> 16U) & 0xFFU;
			gen_tel_pl.payload[91] = (sat_data_buf.data.media.last_page_edc_data >> 8U) & 0xFFU;
			gen_tel_pl.payload[92] = sat_data_buf.data.media.last_page_edc_data & 0xFFU;
			gen_tel_pl.payload[93] = (sat_data_buf.data.media.last_page_px_data >> 24U) & 0xFFU;
			gen_tel_pl.payload[94] = (sat_data_buf.data.media.last_page_px_data >> 16U) & 0xFFU;
			gen_tel_pl.payload[95] = (sat_data_buf.data.media.last_page_px_data >> 8U) & 0xFFU;
			gen_tel_pl.payload[96] = sat_data_buf.data.media.last_page_px_data & 0xFFU;
			gen_tel_pl.payload[97] = (sat_data_buf.data.media.last_page_sbcd_pkts >> 24U) & 0xFFU;
			gen_tel_pl.payload[98] = (sat_data_buf.data.media.last_page_sbcd_pkts >> 16U) & 0xFFU;
			gen_tel_pl.payload[99] = (sat_data_buf.data.media.last_page_sbcd_pkts >> 8U) & 0xFFU;
			gen_tel_pl.payload[100] = sat_data_buf.data.media.last_page_sbcd_pkts & 0xFFU;
