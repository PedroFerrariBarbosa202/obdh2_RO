...
{
    return (uint16_t)((1000UL*(uint32_t)raw*ADC_VREF_MV)/((uint32_t)ADC_RANGE*CURRENT_SENSOR_RL_VALUE_KOHM*CURRENT_SENSOR_GAIN_MA_MV*CURRENT_SENSOR_RSENSE_VALUE_MOHM));
}
